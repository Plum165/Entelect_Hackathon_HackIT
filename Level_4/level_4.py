#!/usr/bin/env python3
"""
Level 4: Multi-Tick Horizon & Formula Diagnostic Solver
World: 200x300 (60,000 cells, 800 ticks) | 1,880 Direct Nodes + Forest Mesh
"""
...
def solve():
    ...
    # 2. Grand 10-Species Harvest Stretched across Ticks 705..798
    ...
    cur_tick = 705
    plants_per_tick = max(1, math.ceil(len(species_queue) / 90))
    ...
    print("=" * 70)
    print(f" LEVEL 4 SCORING FORMULA VARIABLES")
    print("=" * 70)
